    ...
    <>
      ...
      <group {...props} dispose={null} scale={ratioScale * 12}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.casque_metal.geometry}
          material={nodes.casque_metal.material}
          position={[0, 0.202, 0]}
        >
        ...
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.casque_other.geometry}
          material={nodes.casque_other.material}
          position={[0, 0.202, 0]}
        >
          <meshStandardMaterial
            ref={meshRef2}
            normalMap={texture1.normalMap}
            roughnessMap={texture1.roughnessMap}
            metalnessMap={texture1.metalnessMap}
            color={"#ff0000"}
          />
        </mesh>
      </group>
